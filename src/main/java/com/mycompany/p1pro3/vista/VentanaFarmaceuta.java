    ...
    private void actualizarControles() {
        ...
        switch (pestanaSeleccionada) {
            case 0: // Despacho
                ...
                BotonGuardarCambio.setEnabled(false);
                BotonCancelarCambio.setEnabled(false);
...
//                ResultadoRecetastxt.setEnabled(estado.isAdding() || estado.isSearching() || !estado.isViewing());
    ...
    private void initComponents() {
        ...
        tblRecetas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Paciente", "Médico", "Fecha Emisión", "Fecha Retiro", "Estado"
            }
        ) {
        ...
        jScrollPane3.setViewportView(tblRecetaSelec);
        ...
        TabbedHistoricoLayout.setHorizontalGroup(
            ...
            .addGroup(TabbedHistoricoLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(TabbedHistoricoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
